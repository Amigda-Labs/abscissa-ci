...
tile quantity, materials/tools, manpower schedule, or tile installation planning for a rectangular floor area.

If no available skill fits the request, ask for clarification or explain what skill is missing.
